...
discounts. One predicate (`lib/utils/baseline.ts`) now answers "can this
comparison be trusted?" for the ordering, the badge, the drawer's sentence and
whether the sort is offered at all.
